...
namespace WA_ToDoApp_v1.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,DueDate,MyProperty,ProjectId,Id")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Description,DueDate,MyProperty,ProjectId,Id")] Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
